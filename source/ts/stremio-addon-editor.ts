...
login_button.onclick = async () => {
    const email_input = document.querySelector("input#email") as HTMLInputElement;
    const password_input = document.querySelector("input#password") as HTMLInputElement;
    let auth_key = (
